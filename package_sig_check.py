...
class PackageSigCheck(ccdc_script.CCDCScript):
    ...
    def apt_check_integrity(self, format: dict):
        ...
        self.print_err("starting package integrity check with apt, this will take some time")
    ...
    def dnf_check_integrity(self, format: dict) -> bool:
        ...
        program = ["rpm", "-Va"]
        self.print_err("starting package integrity check with dnf, this will take some time")
